package my.study.soccernews.data;

import androidx.room.Room;

import my.study.soccernews.data.local.SoccerNewsDb;
import my.study.soccernews.data.remote.SoccerNewsApi;
import my.study.soccernews.App;
...
public class SoccerNewsRepository {
    ...
    //region Constantes
    private static final String REMOTE_API_URL = "https://lucasfpastre.github.io/api-noticias-dio/";
